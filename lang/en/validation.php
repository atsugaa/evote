...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'MULAI_VOTING' => [
            'required' => 'Mulai voting tidak boleh kosong',
            'date' => 'Tanggal tidak valid',
        ],
        'SELESAI_VOTING' => [ 
            'required' => 'Selesai voting tidak boleh kosong',
            'date' => 'Tanggal tidak valid',
        ...
        'WAKIL_CALON' => [
            'required' => 'Calon wakil tidak boleh kosong',
        ],
        'VISI_CALON' => [
            'required' => 'Visi calon tidak boleh kosong',
        ],
        'MISI_CALON' => [
            'required' => 'Misi calon tidak boleh kosong',
        ],
        'GAMBAR_CALON' => [
        ...
        'nisn' => [
            ...
            'max:10' => 'Hanya terdiri dari :max karakter',
        ],
    ],
