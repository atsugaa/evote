        ...
        <div id="default-styled-tab-content">
            <div class="hidden px-12 py-4 text-center rounded-lg bg-gray-50 " id="styled-profile" role="tabpanel" aria-labelledby="profile-tab">
              ...
              <form action="{{ route('login') }}" method="post">
                @csrf
                <input type="text" name="barcode_data" id="scannerInput" readonly class="hidden" >
              </form>
            </div>
              ...
              <p class=" text-center mt-2">Alternatif login selain menggunakan Qr-Code</p>
                <form action="{{ route('loginManual') }}" method="post" class="max-w-sm mx-auto mt-10 flex flex-col">
                  ...
                  <div class="mb-5">
                    ...
                    <input type="nisn" id="nisn" name="nisn" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required />
                  </div>
                  <div class="mb-5">
